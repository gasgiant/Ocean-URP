...
namespace OceanSystem
{
    ...
    public class WavesSettingsEditor : Editor
    {
        ...
        SerializedProperty foamDecayRate;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (wavesSettings.showGraph)
            {
                SpectrumGraphPlotter.DrawGraphOnly(wavesSettings);
            }
            ...
            EditorGUILayout.PropertyField(foamDecayRate);
            EditorGUI.indentLevel -= 1;
        ...
        void FindProperties()
        {
            ...
            foamDecayRate = serializedObject.FindProperty("foamDecayRate");
